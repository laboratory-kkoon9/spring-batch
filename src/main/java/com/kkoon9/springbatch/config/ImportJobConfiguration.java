package com.kkoon9.springbatch.config;

import com.kkoon9.springbatch.domain.*;
import com.kkoon9.springbatch.item.*;
            ...
            switch (fieldSet.readInt("recordId")) {
                ...
                default:
                    throw new IllegalArgumentException(
                            "Invalid record type was found: " + fieldSet.readLong("recordId")
                    );
            }
        };
    }
